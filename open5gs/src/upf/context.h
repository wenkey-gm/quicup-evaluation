...
typedef enum {
    UPF_TRANSPORT_MODE_GTPU = 0, // Default standard 5G mode
    UPF_TRANSPORT_MODE_QUIC = 1  // Your custom mode
} upf_transport_mode_e;
...
typedef struct upf_context_s {
    ...
    upf_transport_mode_e transport_mode;
    char *quic_cert_path;
    char *quic_key_path;
    ogs_quic_config_t ogs_quic_config;
} upf_context_t;
